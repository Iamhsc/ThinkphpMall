...
Route::resource(':version/auth','api/:version.auth');       //权限管理路由
Route::resource(':version/log','api/:version.log');       //日志管理路由
Route::resource(':version/index','api/:version.index');       //日志管理路由
